...
STORIES = STORIES + (
    ...
    _trivia_story(
        ...
        hero=(
            "郑钦文以外卡身份出战华盛顿站，首轮对阵生涯新高世界第 28 的伊拉；"
            "两人上一次交手是 2023 年杭州亚运会半决赛，郑钦文取胜后夺金。"
        ),
        facts=(
            "伊拉 2005 年 5 月生，2022 年成为菲律宾首位青少年大满贯单打冠军；"
            "2025 年迈阿密以外卡身份连胜奥斯塔片科、基斯与斯瓦泰克闯入四强。",
            "2026 年 7 月 13 日，伊拉升至生涯新高世界第 28 位，为菲律宾球员在 WTA 巡回赛的历史最高排名；"
        ...
        moments=(
            ChampionMoment(
                ...
                player="郑钦文",
                age="杭州亚运会",
                headline="半决赛 6-1、6-7(5)、6-3 胜伊拉",
                detail="该届郑钦文夺得女单金牌，伊拉获得铜牌；这是两人此前唯一一次交手。",
