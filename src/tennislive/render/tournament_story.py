...
# ⚠️ **下面那些 fact 的「压在 120 字以内」现在没有闸了。**
#
# 那条限制原来由 `knowledge._validate_copy_for_publish` 执行——知识帖把每条 fact
# 铺成一段卡片正文，超了排不下。**2026-09-15 图文知识帖那条线整个停产**（账号所有者：
# 「旧样式图片式的知识讲解内容线都移除吧」），校验器连同生成器一起删了。
#
# 这些字数注释**故意留着**：它们是当年为什么这么写的来路，而且这张表还活着
...
STORIES = STORIES + (
    _trivia_story(
        slug="davis-cup-road-to-bologna",
        title="通往决赛圈之路",
        subtitle="网球观察 · 赛制篇",
        identity="157 个国家，8 张门票",
        chips=("赛制与晋级", "戴维斯杯", "2026"),
        hero=(
            "2025 年有 **157 个国家**报名戴维斯杯，11 月站上决赛圈的只有 **8 支**。"
            "而这 8 张门票里**只有 1 张是送的**——东道主意大利的外卡；"
            "剩下 7 张，全要在 2 月和 9 月两道主客场的关口里打出来。"
        ),
        facts=(
            "**八个名额的来路**：1 张外卡给东道主意大利（他们连着三年捧杯，今年决赛圈又在自己主场），"
            "另外 7 张是 9 月**资格赛第二轮**的胜者。年初有机会争冠的一共 28 队——"
            "2 张外卡加 26 支打资格赛的球队。",
            "**四个层级，每年升降级**：最上面是资格赛，往下依次是世界组 I、世界组 II，"
            "再往下是按地理分区的地区赛。**资格赛听着像预赛，其实是离奖杯最近的那一层**——"
            "赢两轮就进决赛圈；2 月在资格赛第一轮输掉的队，9 月只能回世界组 I 去打。",
            "**两道关都是 5 场 3 胜的主客场**：第一天两场单打，第二天一场双打加两场单打，"
            "先拿 3 分的球队晋级。布拉格那一场打满了五场——**捷克 3-2 淘汰美国**，"
            "而美国是这项赛事夺冠最多的国家（32 次），定胜负的第五场是莱赫奇卡拿下的。",
            "**韩国从首尔打进来了**：2 月在釜山 3-2 掀翻 9 号种子阿根廷，9 月主场 3-1 送走印度。"
            "而去年站上决赛圈的那八支，是阿根廷加七支欧洲队，**一支亚洲球队都没有**。",
            "**决赛圈换另一套规矩**：11 月 24-29 日在博洛尼亚打六天，"
            "不再是 5 场 3 胜而是 **3 场 2 胜**（两单一双），也不再有主客场，"
            "8 支球队抽签后**单败淘汰**，输一场就回家。",
        ),
        moments=(
            ChampionMoment(
                date="2026-09-19", player="韩国队", age="—",
                headline="首尔那块牌子",
                detail=(
                    "3-1 送走印度之后，韩国队在场地中央举起晋级牌，"
                    "上面印着 SEE YOU IN THE FINAL 8。"
                ),
                source_url="https://www.daviscup.com/en/tie/984ef5cc-d54e-406a-887c-e2be8e845171",
            ),
            ChampionMoment(
                date="2026-09-19", player="捷克队", age="—",
                headline="打满五场淘汰美国",
                detail=(
                    "布拉格 O2 Arena，捷克 3-2 送走 32 次夺冠的美国，"
                    "定胜负的第五场由莱赫奇卡拿下。"
                ),
                source_url="https://www.daviscup.com/en/tie/91e98b77-64c5-4588-bd60-6bb61e6f9c5d",
            ),
            ChampionMoment(
                date="2025-11-23", player="意大利队", age="—",
                headline="第三年把杯子留在家里",
                detail=(
                    "2025 年决赛 2-0 胜西班牙，意大利完成三连冠；"
                    "今年的决赛圈仍然摆在博洛尼亚。"
                ),
                source_url="https://www.daviscup.com/en/davis-cup-final-8-all-you-need-to-know",
            ),
        ),
        image_keys=(),
        source_label="戴维斯杯官方",
        source_url="https://www.daviscup.com/en/davis-cup-final-8-all-you-need-to-know",
        evidence_urls=(
            "https://www.daviscup.com/en/about/format",
            "https://www.daviscup.com/en/calendar",
            "https://api.itf-production.sports-data.stadion.io/custom/tieCentre/984ef5cc-d54e-406a-887c-e2be8e845171",
        ),
    ),
    _trivia_story(
    ...
    _trivia_story(
        ...
        hero=(
            "ATP 说世界排名数 19 个成绩，WTA 说 18 个——其实两边都是 18 个必算的"
            "位置，再加一个年终总决赛。一年打 25 个赛事也可以，可位置就那么多，"
            "而且大部分早被规则书钉死。这套算法奖励的从来不是出勤，是高度。"
        ),
        facts=(
            ...
            "**和规则书 9.03 B 逐条对得上**——也就是说不打总决赛的人，实际算的是 18 个。",
            ...
            "⚠️ 多哈和迪拜**曾经**逐年在 1000 和 500 之间轮换，**2024 年起两站同时"
            "固定为 WTA 1000**，女子独办这一桶从那一年才定型成今天这三站。",
            "**「19」和「18」其实是同一个结构**：ATP 9.03 B 把 4 大满贯 ＋ 8 个大师赛 ＋ "
            "年终总决赛 ＋ 最好 6 个加在一起报 19；WTA VIII.A.4.a.i 报 18，再写明"
            "`if she played the WTA Finals ... added to her total points as a bonus "
            "Tournament`。**两边都是 18 个必算 ＋ 总决赛，差的只是谁把总决赛算进了"
            "那个数。真正不同的是双打**：ATP 最好 19 个（总决赛在里面抢位置）、WTA 最好 12 个。",
            "**被承诺绑住的人不一样**：ATP 只绑**前 30**（按上一年 11 月 10 日排名钉死，"
            "全年不变）；WTA **不设门槛**，`all players must play ... if they are "
            "accepted`——排名够得着正赛就被绑住，不打记 0 分、挂满 52 周（未满 18 岁另有一张减免表）。",
    ...
    _trivia_story(
        ...
        chips=("告别赛季", "八张外卡", "最后一站"),
        # ⚠️ 知识帖正文按段落卡 120 字（见上面那条 120 字的说明），hero 单独
        # 成一段。原来那版 133 字，把两个日期都写全就超了——日期收进「第二天」。
        hero=(
            "2026 年美网发了八张男单正赛外卡，其中两张是和法网、澳网互换的名额，"
            "美网自己能给的六张全给了美国人；2016 年的美网冠军瓦林卡一张都没有。"
            "8 月 25 日他发文告别纽约，第二天拿到第八张的基普森因伤退赛，"
            "位置才转给了他。"
        ),
        facts=(
            # ⚠️ 知识卡按 40 字截，截口要落在句读上（`test_knowledge_card_facts_'
            # never_hard_truncate_mid_clause`）。原来那版第 40 字正好卡在
            # 「五名美国年轻人（迈」——括号刚开就被切断。把「，」挪到第 24 字。
            "八张外卡的去向是这样的：8 月 18 日公布七张，8 月 22 日补上第八张。"
            "其中孟菲尔斯（法国）和波皮林（澳大利亚）走的是交换名额——USTA 与法国网协、"
            "澳大利亚网协各有一份互换协议，美网让出这两张，换回美国球员打法网和澳网的名额。"
            "美网真正能自己决定的六张，全给了美国人：迈克尔·郑、马丁·达姆、肯尼迪、"
            "戈尔兹尼、沃尔夫，以及 8 月 22 日拿到第八张、世界第 116 位的基普森。"
            "瑞士没有这样的互换协议，瓦林卡也没有报名资格赛；当时有人批评这个决定。"
            "8 月 26 日基普森因伤退赛，美网把位置转给瓦林卡，官方稿写明："
            "这将是他最后一次在纽约打球。",
            "他打过四次大满贯决赛，赢下的三次里每一次对面都是当时的世界第一："
            "2014 年澳网胜纳达尔，2015 年法网和 2016 年美网两次胜德约科维奇；"
            "唯一输掉的一次是 2017 年法网决赛负于纳达尔，那年的世界第一是穆雷。"
            "他也是极少数在大满贯赛场上把纳达尔、德约科维奇、费德勒和穆雷"
            "四个人都赢过一遍的球员。",
            "今年前三个大满贯都给了他一个告别：1 月澳网打进第三轮，是 1978 年以来"
            "第一个打进大满贯第三轮的 40 岁以上男子球员，输给弗里茨后赛事总监上场"
            "与他共饮啤酒；5 月法网他和孟菲尔斯拿外卡同日首轮出局；"
            "6 月温网他持外卡出战，首轮四盘全部进入抢七、以 6-7(9) 7-6(16) 7-6(7) "
            "7-6(5) 负于贝雷蒂尼，历时 4 小时 20 分，第二盘抢七 18-16、他手握六个盘点未能保住。"
            "他 2002 年转职业，2026 年 3 月满 41 岁，现在世界第 127 位；"
            "生涯 16 个单打冠军，末冠停在 2017 年，其后两次膝盖手术、"
            "2021 年两次足部手术。",
        ),
        moments=(
            ChampionMoment(
    ...
    _trivia_story(
        slug="promotional-fees",
        title="请得动球星的那条规则",
        subtitle="网球观察 · 规则篇",
        identity="只有两档赛事可以花钱请人",
        chips=("1.16 推广费", "500 和 250 可以", "金额从不公布"),
        hero=(
            "ATP 2026 规则书第一章 1.16「推广费」：球员默认不得收取任何"
            "用于影响或确保其参赛的钱，奖金除外；全书只给一个例外——"
            "ATP 500 与 ATP 250 赛事可支付「推广服务费」，其余一律不许。"
        ),
        facts=(
            "ATP 2026 规则书第一章 1.16 Promotional Fees A 款："
            "除 B 款明确允许者外，球员不得接受任何来源、直接或间接给予的、"
            "用于影响或确保其参加任何 ATP 巡回赛或挑战赛的金钱或任何有价值之物，"
            "奖金除外，除非经 ATP 授权。B 款：ATP Tour 500 与 ATP Tour 250 赛事"
            "可选择支付推广服务费（fees for promotional services），"
            "其余任何 ATP 巡回赛或挑战赛的赛事所有者、运营方、赞助商或代理人"
            "一律不得提供、给予或支付金钱或任何有价值之物。"
            # ⚠️ 这一条是**两版逐字比过的**，不是假设它没改：2024 版（节号 1.15）
            # 与 2026 版（1.16）正文 828 字符对 828 字符，零差异；节号变动是因为
            # 2026 在其前面插入了 1.15 Special Events - Exhibitions。
            "该条文 2024 版（当时编为 1.15）与 2026 版正文逐字一致。",
            "同书第八章 The Code · C. Promotional Fees 规定罚则与执法："
            "球员违规的罚款上限按级别递增——挑战赛 2 万、ATP 250 三万、"
            "ATP 500 四万、ATP 大师赛 1000 六万美元，另追缴该笔款项的价值，"
            "并可停赛最长三年，连续违规罚款上限每次增加百分之一百。"
            "赛事违规者罚款最高 10 万美元、追缴该笔补偿、终止会籍，"
            "并没收此前已付予 ATP 的全部款项。",
            "同节另规定查账权：ATP 首席执行官或规则与竞赛高级副总裁认为"
            "某赛事可能违反本节时，赛事方必须应要求提供其掌握的全部相关记录的"
            "查阅权与复印件；无相关记录者须出具详述事实的宣誓书。"
            "拒不提供者可处最高 10 万美元罚款并终止会籍。"
            "规则书未要求披露推广服务费的金额，公开渠道亦无该金额的记录。",
            # ⚠️⚠️ 这一条是这份 facts 里最重要的一条，**不许删**。它把
            # 「规则允许」和「这两个人拿了钱」之间那道线画出来——后者没有任何
            # 一手证据，而这条片子一次都不能说。
            "2026 年 9 月 30 日至 10 月 6 日，辛纳参加北京中国网球公开赛（ATP 500），"
            "阿尔卡拉斯参加东京日本公开赛（ATP 500），两站同周举行。"
            "2025 年同周两人亦分处两地，分别在北京与东京夺冠。"
            "阿尔卡拉斯 2024 年在北京夺冠、2025 年改赴东京并夺冠，2026 年回东京卫冕，"
            "其公开说法为希望前往此前未打过的球场。"
            "无任何公开记录显示上述参赛与推广服务费有关。",
        ),
        # ⚠️ 这三条**只记规则书自己说的话和两站的公开事实**，一条都不涉及
        # 「谁拿了钱」——那件事没有任何一手出处（见 facts 最后一条）。
        moments=(
            ChampionMoment(
                date="2026-01-25",
                player="ATP 规则书",
                age="第一章 1.16",
                headline="「500 和 250 可以支付推广服务费」",
                detail=(
                    "B 款为全书唯一例外：ATP Tour 500 与 ATP Tour 250 赛事"
                    "可选择支付推广服务费，其余任何赛事的所有者、运营方、"
                    "赞助商或代理人一律不得给予球员金钱或任何有价值之物。"
                    "该条文与 2024 版（当时编为 1.15）正文逐字一致。"
                ),
                source_url=(
                    "https://www.atptour.com/-/media/files/rulebook/2026/"
                    "2026-rulebook-chapter-1_atp-circuit-regulations25jan26.pdf"
                ),
            ),
            ChampionMoment(
                date="2026-01-25",
                ...
                headline="「必须交出全部相关记录」",
                detail=(
                    "违规给钱：球员罚款上限按级别递增至大师赛 6 万美元并追缴，"
                    "最多停赛三年；赛事方罚款最高 10 万美元并可终止会籍，"
                    "且须应要求交出全部相关记录或出具宣誓书接受查账。"
                    "规则书未要求披露金额。"
                ),
                source_url=(
                    "https://www.atptour.com/-/media/files/rulebook/2026/"
            ...
            ChampionMoment(
                ...
                headline="「想去一个没打过的球场」",
                detail=(
                    "他 2024 年在北京夺冠，2025 年改赴东京并在决赛 6-4、6-4"
                    "击败弗里茨夺冠，2026 年回东京卫冕；同一周辛纳在北京。"
                    "他给出的公开理由是希望前往此前未打过的球场。"
                ),
                source_url=(
                    "https://www.atptour.com/en/news/alcaraz-fritz-tokyo-2025-final"
                ),
            ),
        ),
        image_keys=(),
        source_label="ATP 2026 官方规则书 第一章 1.16 / 第八章 The Code",
        image_credit="ATP 官方图 · atptour.com",
        source_url=(
            "https://www.atptour.com/-/media/files/rulebook/2026/"
            "2026-rulebook-chapter-1_atp-circuit-regulations25jan26.pdf"
        ),
    ),
    # 2026-09-16 选题：WTA 当天官宣年终总决赛 2027–2029 落户夏洛特，全球总部一并
    # 迁过去。账号所有者甩来的小红书截图问的是「啥时候总决赛能回归深圳呀」——
    # 而那条截图漏了中间一整段：**2026 年这一届已经先从利雅得挪到了印第安维尔斯**，
    # 沙特那份三年合同提前一年终止。所以这条片子的主语不是「又换了一次」，
    # 是「**八届换了七座城市**」这条线本身。
    #
    # ⚠️ 全套账（每一届的奖金、公告日期、球员批评的原话、不许写的两句）在
    # research/wta-finals-venues-2026.md。改文案之前先读那份，别重查。
    _trivia_story(
        slug="finals-venues",
        title="总决赛为什么总在搬家",
        subtitle="网球观察 · 赛事篇",
        identity="它从来就没有自己的家",
        chips=("15 座城市", "第一条标准是钱", "2027 夏洛特"),
        hero=(
            "WTA 年终总决赛 1972 年至今去过 15 座城市，从来没有固定场地；"
            "举办权每隔几年重新招标，而 WTA 自己列的第一条评标标准就是"
            "「有没有能力出资办一场世界级赛事」。撑住那笔钱的历来不是赛事本身——"
            "深圳那份十年由地产商中标，利雅得那三年由沙特主权基金冠名，"
            "所以外部一变，合同就断。"
        ),
        facts=(
            # ⚠️⚠️ 这条片子的主语是「**为什么**变来变去」，不是编年史。
            # 第一版写成了「第 N 年去了哪」，账号所有者当场顶回来：
            # 「要讲出为什么会变来变去」。下面前两条是那个「为什么」，
            # 其余几条是它的注脚（证据），顺序不许倒过来。
            # ⚠️ 开头那个逗号的位置是判据卡出来的：`_CLAUSE_MARKS` **不认顿号**，
            # 而知识卡要求首个断句点落在第 20 到 40 个字之间，否则会拦腰截断。
            # 原来写的是「…15 座城市——博卡拉顿、洛杉矶…」，四十字内一个逗号都没有。
            "WTA 年终总决赛从 1972 年办到今天，去过 15 座城市：博卡拉顿、洛杉矶、纽约、"
            "奥克兰、慕尼黑、马德里、多哈、伊斯坦布尔、新加坡、深圳、瓜达拉哈拉、"
            "沃斯堡、坎昆、利雅得、印第安维尔斯，从来没有过固定场地，"
            "举办权每隔几年重新招标一次；2012 年那一轮有 43 座城市表示过兴趣。"
            "作为对照，温网自 1922 年、法网自 1928 年、美网自 1978 年、"
            "澳网自 1988 年起，各自一直在同一块场地上打。",
            "WTA 2024 年宣布利雅得承办的官方通稿列出三条评标标准，"
            "第一条是「有没有能力出资（fund）办一场世界级的赛事」，"
            "第二条是「支不支持 WTA 大幅提高奖金的野心」，第三条才是长期承诺。"
            "所以每换一个东家总奖金就跳一次：新加坡 700 万、深圳 1400 万、"
            "瓜达拉哈拉与沃斯堡各 500 万、坎昆 900 万、利雅得 1525 万美元。",
            # ⚠️ 这一条是因果链的底层，**不是道德判断**。片子不指控任何一方，
            # 说的是一个结构事实：赛事的钱来自赛事之外，举办地就随那笔钱波动。
            "撑住那笔奖金的历来不是赛事自己的收入：深圳那份十年由地产商金地集团"
            "中标并承诺建馆，利雅得那三年的赛事全称是 WTA Finals Riyadh "
            "presented by PIF，PIF 为沙特主权财富基金。两份合同最后都断在赛事之外的"
            "变化上——深圳那届之后因疫情停办，此后再未恢复举办；"
            "利雅得那份被双方提前一年终止。",
            "2018 年 1 月 WTA 宣布深圳承办 2019 至 2028 年共十年，"
            "总奖金由新加坡时代的 700 万美元翻倍至 1400 万美元。"
            "2019 年 10 月 27 日至 11 月 3 日首届在华润深圳湾体育中心举行，"
            "巴蒂决赛 6-4、6-3 胜斯维托丽娜，独得 442 万美元，"
            "为当时网球史上最高的单项奖金。2020 年因疫情停办。"
            # ⚠️⚠️ 这条片子**不许**写「那份合同已经终止／作废」，也不许写
            # 「深圳还剩几年举办权」——WTA 从未公开宣布过合同的法律状态，
            # 英文报道里「suspended」「effectively over」「contractually
            # obligated through 2031」三种说法互相打架，一个都没有官方出处。
            # 能写的只有两句，而且两个源对得上：当初宣布的是 2019–2028；
            # 2027 和 2028 已经归了夏洛特。读者自己会算，不用我们下结论。
            "2019 年之后总决赛再没回过深圳；2027 与 2028 两个年份已归夏洛特。",
            "没有长约的那三年，公告一次比一次晚、奖金一度掉到深圳那届的三分之一强："
            "2021 年 9 月 13 日才宣布移师墨西哥瓜达拉哈拉，总奖金 500 万美元；"
            "2022 年 9 月 6 日才宣布落在得州沃斯堡，仍是 500 万美元，"
            "首日佩古拉对萨卡里一场场内座位填不到两成，赛事中途下调票价；"
            "2023 年 9 月才敲定坎昆，总奖金回到 900 万美元。",
            "2023 年坎昆那届的球场是临时搭在 Paradisus 酒店场地上的，"
            "造价约 600 万美元、4300 座，为该项赛事史上最小；"
            "看台与球场开赛前几天才完工。萨巴伦卡称这是 WTA 对球员"
            "「另一个层级的不尊重」，并说球员在这块场地上移动时有时都觉得不安全；"
            "邦德罗索娃说「说实话，这块场地非常糟糕」。"
            "风雨还把赛程冲垮：半决赛只打三局即中断顺延，决赛被推到了周一。",
            "2024 年 4 月 WTA 宣布沙特承办 2024 至 2026 年共三年。"
            "2024 年那届总奖金 1525 万美元，较坎昆那届上涨 69.44%，"
            "决赛高芙 3-6、6-4、7-6(2) 胜郑钦文；"
            "2025 年总奖金 1550 万美元，莱巴金娜 6-3、7-6(0) 胜萨巴伦卡，"
            "全胜夺冠独得 523.5 万美元，为女子体育史上最高的单项奖金。",
            # ⚠️ 「中东战事」是**媒体归因**，不是 WTA 给的理由。片子里只能写
            # 「报道说」，不能写「因为」。联合声明里能引的只有 requested 那半句。
            # ⚠️ 同上：首个逗号必须落在第 20 到 40 字之间。原来写「2026 年双方共同
            # 同意提前一年终止，」，那个逗号在第 18 字，差两个字被判成硬截断。
            "沙特那份三年合同 2026 年由双方共同同意提前终止，联合声明称"
            "「WTA 主动要求把 2026 年总决赛移至新的举办地」——"
            "报道普遍将其与中东的战事与地缘局势联系起来，"
            "三月迪拜赛后一批球员与工作人员曾一度滞留该地区。"
            "2026 年这一届 11 月 8 日至 15 日落在印第安维尔斯网球花园，"
            "总奖金 1550 万美元，**合同只有一年**；"
            "WTA 自己在夏洛特的通稿里称它是「通往下一章的桥」。",
            "2026 年 9 月 16 日 WTA 宣布夏洛特承办 2027 至 2029 年三届，"
            "场馆为 NBA 夏洛特黄蜂主场 Spectrum Center，"
            "部分活动放在 Charlotte Convention Center；"
            "WTA 同时把全球总部从佛罗里达州圣彼得斯堡迁往夏洛特，"
            "并承诺 2029 年之后若当地建成专用网球场馆，再落一站 WTA 500 赛事。"
            "WTA 主席 Valerie Camillo 称其目标是把这项赛事做成"
            "「女子体育的超级碗」。",
            # 这条是片子的落点：同一个场馆、同一个「年终」的位置、隔了六年，
            # 而且 2026 年这一届就在片子发出去的下一周。
            # ⚠️ 不许写成「深圳赢回来了」——比利·简·金杯是国家队赛事，
            # 年终总决赛是个人赛事，两件事。
            "比利·简·金杯决赛 2025 至 2027 年落户深圳，场馆正是深圳湾体育中心，"
            "与 2019 年那届 WTA 年终总决赛同一座；2026 年这一届为 9 月 22 日至 27 日。",
        ),
        moments=(
            ChampionMoment(
                date="2018-01-17",
                ...
                headline="十年举办权，奖金翻倍",
                detail=(
                    "WTA 宣布深圳承办十年，总奖金由 700 万美元提升至 1400 万美元；"
                    "2019 年首届巴蒂独得 442 万，当时网球史上最高单项奖金。"
                ),
                source_url="https://www.espn.com/tennis/story/_/id/22138547/shenzhen-china-host-wta-finals-2028",
            ),
            ChampionMoment(
                date="2023-10-30",
                player="萨巴伦卡",
                ...
                headline="「另一个层级的不尊重」",
                detail=(
                    "临时球场搭在酒店场地上，开赛前几天才完工。"
                    "时任世界第一批评 WTA 对球员不尊重，称球员移动时有时都觉得不安全。"
                ),
                source_url=(
                    "https://www.espn.com/tennis/story/_/id/38779663/"
                    "wta-defends-temporary-hard-court-built-cancun-season-ender"
                ),
            ),
            ChampionMoment(
                date="2026-09-16",
                ...
                headline="总部也搬过去",
                detail=(
                    "赛事落 Spectrum Center 三年，WTA 全球总部由佛州圣彼得斯堡迁入；"
                    "若当地建成专用网球场馆，2029 年之后再加一站 WTA 500。"
                ),
                source_url="https://tennistourtalk.com/137498/wta-announces-new-host-for-2027-2029-wta-finals",
            ),
        ),
        image_keys=(),
        source_label="WTA 官方通稿 / ESPN / Sky Sports / 各届赛事公开资料",
        image_credit="WTA 官方图 · photoresources.wtatennis.com",
        source_url="https://tennistourtalk.com/137498/wta-announces-new-host-for-2027-2029-wta-finals",
    ),
    _trivia_story(
    ...
    _trivia_story(
        ...
        facts=(
            ...
            # ⚠️ 这一条压在 120 字以内是硬要求：知识帖当年把每条 fact 铺成
            # 知识帖的一段，而 当年那条判据（已随线停产删掉）
    ...
    _trivia_story(
        ...
        facts=(
            # ⚠️ 每条都压在 120 字以内：知识帖当年把每条 fact 铺成知识帖的
            # 一段，当年那条判据（已随线停产删掉）
    ...
    _trivia_story(
        ...
        chips=("冷知识", "时代档案", "24 年来第一次"),
        # ⚠️ 这一段会整段进小红书文案，而那儿单段上限 120 字
        # （见上面那条 120 字的说明）。
        hero=(
            "2026 年 9 月 14 日，德约科维奇从第 5 掉到第 12——前十里，"
            "费德勒、纳达尔、德约科维奇一个都没有了。上一次这样是 2002 年 10 月，"
            "那个月费德勒才刚刚第一次挤进前十。"
        ),
        facts=(
            "2026-09-14 那期 ATP 排名，德约科维奇 5 → 12，三巨头同时不在前十——"
            "上一次是 2002 年 10 月。两个独立源对上（ESPN／IANS「drops seven places」），"
            "当期前十另从 tennisexplorer 的 14.09.2026 榜单逐行核过。",
            "三个纪录各是一套算法，**不是一张排行榜**："
            "纳达尔连续 912 周待在前十（2005-04-25 到 2023-03-13）、"
            "费德勒连续 237 周世界第一、德约科维奇累计 428 周世界第一。",
            "2002 年 10 月那个月：世界第一是休伊特，费德勒当月才第一次进前十，"
            "纳达尔 16 岁、德约科维奇 15 岁（按出生日期算，不是抄的）。"
            "二十四年后，休伊特的儿子克鲁兹 17 岁，已经在打职业巡回赛。",
    ...
    _trivia_story(
        ...
        chips=("冷知识", "排名", "世界第一"),
        # ⚠️ 这一段会整段进小红书文案，而那儿单段上限 120 字
        # （见上面那条 120 字的说明）。第一版写了 121 字，差一个字红。
        hero=(
    ...
    _trivia_story(
        ...
        facts=(
            ...
            "2028 年沙特将加入，成为第十站。",
            "⚠️⚠️ **辛吉斯集齐过她那个年代的九站一级赛（Tier I），2000 年 10 月完成，"
            "20 岁，比德约早 18 年。** 这是片子发出去之后读者在评论区指出来的，核实成立："
            "1998–2000 年 Tier I 固定九站（东京、印第安维尔斯、迈阿密、希尔顿海德、"
            "罗马、柏林、加拿大、苏黎世、莫斯科），她全部拿过——最后两块是 2000 年 10 月"
            "连着的苏黎世和克里姆林杯（当年第 8 冠、生涯第 34 冠）。"
            "⚠️ **片子那句「女子这边找不到对应的说法」字面上仍然成立**（确实没有名字、"
            "没有吉尼斯条目），**但读者读到的是「女子没人做到过」，而那是错的**。"
            "更难受的是：我们自己那把「按今天这十个场地数」的尺子**恰好把她藏了起来**——"
            "今天这十站她只拿过四个（印第安维尔斯、迈阿密、罗马、加拿大），"
            "她真正集齐的东京、查尔斯顿、柏林、苏黎世、莫斯科今天一个都不是 WTA1000。"
            "**下一条讲这个题材的片子必须先说辛吉斯。**",
            "⚠️⚠️ **「要拿满先得有一张固定的表」这个因果是错的**，同一条评论里的第二点："
            "「德约之前也没有男子集齐过当时的大师赛」——核实成立，而且比字面更狠。"
            "ATP／吉尼斯的定义是「**1990 年设立以来的这九站**」，也就是**今天的九站**，"
            "不是「你那个年代的九站」：德约那九站横跨 2007 迈阿密到 2018 辛辛那提，"
            "中间表改过一次（2009 汉堡出、上海进），照样算集齐，因为**历年冠军都算数**。"
            "**德约自己就没集齐过他那个年代的**——汉堡（1990–2008 是大师赛，他 2005 年出道）"
            "和马德里室内（2002–2008）他都没拿过。"
            "而阿加西 17 座、桑普拉斯 11、张德培 7、库里尔 5、罗迪克 5，"
            "五个人 45 座大师赛没有一个人拿过蒙特卡洛。"
            "所以「表在变」不是女子拿不满的原因；**真正的原因是女子那十站里有四站"
            "（多哈、迪拜、北京、武汉）晋级到这个级别太晚**。"
            "⚠️ 而我们那把尺子（按今天十站数、不管当年什么级别）用的恰恰是正确逻辑——"
            "**错的是第 ④ 屏的因果，不是尺子。**",
        ),
        moments=(
            ChampionMoment(
...
def story_ranking(digest: Digest) -> list[dict]:
    ...
    单独抽出来是因为产物里只留"谁赢了"不够：落盘的 `rejected_candidates` 曾经
    是空的——离线复算全部通过的候选，根本没被生产环节试过。只记胜者的时候，
    "今天没有候选"和"有但没轮到它"长得一模一样。
    """
    matches = digest.results + digest.live + digest.schedule
    ...
    rank = 0
    seen: set[str] = set()
    for record in [*pinned, *fresh, *cooling]:
