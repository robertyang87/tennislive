...
STORIES = STORIES + (
    ...
    _trivia_story(
        ...
        hero=(
            "2026 年美网发了八张男单正赛外卡，八张里没有 2016 年的美网冠军瓦林卡——"
            "而他今年是告别赛季，也没有报名资格赛。8 月 25 日他自己发文告别纽约；"
            "第二天，拿到第八张的基普森因伤退赛，美网把那个位置转给了他。"
        ),
        facts=(
            ...
            "八张外卡的去向是这样的：8 月 18 日公布七张，给了孟菲尔斯、波皮林和五名"
            "美国年轻人（迈克尔·郑、马丁·达姆、肯尼迪、戈尔兹尼、沃尔夫）；"
            "8 月 22 日的第八张给了世界第 116 位的美国球员基普森。"
            "瓦林卡没有报名资格赛，外卡是他进正赛的唯一一条路；当时有人批评这个决定。"
