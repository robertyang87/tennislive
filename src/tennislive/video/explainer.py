...
<svg viewBox="0 0 900 560" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="450" y="318" text-anchor="middle" font-size="28" fill="#f4fbf7">但同一条写着五个身份都必须打</text>
...
_CAPTIONS: dict[str, dict] = {
    ...
    "wuhan-alternate": {
        ...
        "hook": (
            "武网名单出来了，郑钦文排在替补第七——她还剩三条路\n"
            "9 月 16 日武网公布首批 43 人名单，世界前十悉数出战。郑钦文不在这 43 个人里，"
            "以世界第 52 排在正赛替补第 7 位。报名截止那天是 9 月 14 日，"
            "她刚靠美网八强从第 121 涨回第 52，还是差 7 位。\n"
            "三条路：等 7 个直接入围的人退赛递补；靠中网打进四强，拿到整站唯一那个特殊豁免；"
            "或者 10 月 10 日自己去打资格赛连赢两场。"
            ...
            "所以不去不记 0 分。但从那三条路里任何一条进去的那一刻，这一条立刻生效。"
...
_OPENINGS: dict[str, dict] = {
    ...
    "wuhan-alternate": {
        "topic": "郑钦文排在武网替补第七位",
        "question": "郑钦文进得了武网正赛吗？",
        # ⚠️ 第一句 12 字，落在 5 秒决定窗口内；那一问 12 字，排一行 96px，
        # 高于 84px 的门槛，不会断成两行。两条都量过再写的。
        "narration": (
            "郑钦文进得了武网正赛吗？"
            "今天武网公布首批参赛名单，四十三个直接入围的名额里没有她，"
            "她排在替补名单第七位。"
