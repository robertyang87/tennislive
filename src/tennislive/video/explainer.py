...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "shang-nishikori": (
        ...
        (
            ...
            "他自己说：我其实还想继续打。",
            # 原来是一张来源只写「2025 年」的反手特写：脸很大，赛事不明，也看不出
            # 他在哪儿打球。换成 Tennis.jp 现场报道里的这张——2025 年 11 月横滨庆应
            # **挑战赛**，图注写着「飛びつく錦織圭」。这一屏讲的正是他掉到挑战赛，
            # 画面本身就是那个处境。
            "assets/explainer/shang-nishikori/nishi_now.jpg",
            "Tennis.jp 现场报道 · 2025 年 11 月横滨庆应挑战赛，锦织圭",
            (
                "2026 年 4 月宣布，这是最后一季",
                "曾经的世界第 4，现在世界第 464",
                "今年多在挑战赛，本站靠外卡",
        ...
        (
            ...
            "assets/explainer/shang-nishikori/shang_matchwinner.jpg",
            "图片社图 · 2024 年 9 月成都公开赛，场边大屏打出商竣程的名字",
            (
