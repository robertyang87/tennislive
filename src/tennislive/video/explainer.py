...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "svitolina-handshake": (
        ...
        (
            ...
            "标准",
            "不是按国籍画的",
            "但这条线不是按国籍画的。莱巴金娜也是俄罗斯出生，斯维托丽娜和她握手——"
            "因为莱巴金娜二〇一八年就改籍哈萨克斯坦，那时候战争还没开始。"
            "卡萨金娜同样握手，因为她公开反对这场战争。"
            "斯维托丽娜自己说过，改国籍是很多年前的事，早在战争和入侵开始之前。"
            "可波塔波娃二〇二五年底才改籍奥地利，比战争晚了将近四年，也没有公开表过态。"
            "她说过奥地利像她的第二个家——二〇二三年，"
            "她确实在林茨捧起过一座巡回赛冠军奖杯。"
            "捧杯是一回事，改籍的时间点是另一回事。",
...
_CAPTIONS: dict[str, dict] = {
    ...
    "svitolina-handshake": {
        "hook": (
            ...
            "是她 4 年没变过的界限。\n"
            "但这条线不是按国籍画的：2018 年就改籍、公开反战的选手她都握手，"
            "只有战时才改籍、又没表过态的，不握。"
        ),
