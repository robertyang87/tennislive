...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    "second-serve-clock": (
        (
            ...
            "至于拍几下球，规则里一个数都没有。",
            "", "示意图 · 网球时差绘制",
            ("计时器只对一发生效", "二发只有两个词：不得延误", "拍几下球也没有上限"),
            rule_quotes(),
        ),
        (
        ...
        (
            ...
            "是大满贯决赛史上最长的一场；"
            "两个人分与分之间，平均用掉三十秒和三十三秒。"
            "第二年巡回赛开始严格执法，"
            "纳达尔的评价是：这是一场灾难。",
            "", "示意图 · 网球时差绘制",
            ("1989 那场，他还发了一记下手发球", "2013 年巡回赛开始严格执法",
             "纳达尔当时的评价：这是一场灾难"),
            slow_play_history(),
        ),
        (
...
_OPENINGS: dict[str, dict] = {
    "second-serve-clock": {
        "topic": "一发有钟，二发没有",
        "question": "12040 下球，算违规吗？",
        "narration": "一万两千零四十下球，算违规吗？不算。"
                     "因为发球的钟只管一发——"
                     "二发那一段，规则里一个数都没有。",
        "diagram": gap_timeline(),
        "credit": "示意图 · 网球时差绘制",
