...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "venus-potapova": (
        ...
        (
            ...
            (
                "2006 年在《泰晤士报》写下「我只是二等冠军」",
                "2007 年温网同酬，她拿到第一张等额支票",
                "7 座大满贯、4 枚奥运金牌、49 个巡回赛冠军",
            ),
        ),
        (
            "streak",
        ...
        (
            ...
            "变成实力；一个四十六岁，七座大满贯、四块奥运金牌，还有一整个巡回赛的女子"
            "都在拿的那份等额奖金——她早就不需要再证明什么了，却仍然要从一张外卡开始打首轮。"
            "同一天的同一站，郑钦文也拿着外卡打首轮。这一轮的球场上，"
            "站着好几个本来不该在这儿的人。比分我们不猜。",
            "assets/explainer/venus-potapova/venus_fans.jpg",
            "Getty Images via Evening Standard · 2025 年 7 月 22 日华盛顿站赛后",
            (
                "7 月 27 日首轮，两人第一次交手",
