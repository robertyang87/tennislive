...
from .qualifier_charts import ceiling_cover, qualifier_board
...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    # ⚠️ 这条片子第一版是**四张示意图 + 两张照片**，发出去之后账号所有者点名：
    # 「要多几个实际例子」「要配图啊，不要全是文字的卡片」。CLAUDE.md 里
    # `heat-rule` 那条记着同一句话（「我需要更多是图片或视频，而不是文字卡片」）
    # ——而「五个人的时间轴」「男女赛制对照」这两张恰好是最像文字卡片的东西：
    # 几行字装进几个框，示意图那一节说的「照片讲不清才画」在它们身上不成立。
    # 现在是**六屏照片 + 一张表**，两张纯文字图连同它们的渲染函数一起删了
    # （`men_semifinal_timeline` / `draw_format`）。
    #
    # ⚠️ 唯一留下的那张表是真的「照片讲不清」：八个格子摆在一起时的样子，
    # 没有任何一张实拍讲得了。而**表最容易画成假的**：口径混一条，八个格子就全错。
    # 三条钉死在 `qualifier_charts` 的模块 docstring 里（公开赛年代 / 不含幸运落败者 /
    # 单打），每一格的两个独立源也在那儿逐条记着。
    #
    # ⚠️ 拉杜卡努 2021 那一格**故意没有照片**：美网官方图片接口只回溯到 2024，
    # Commons 上她 2021 夺冠那一周一张都没有。CLAUDE.md「拿不到实拍的时刻，
    # 不用近似照片顶替」——她那一格由 ② 屏那张表承担。
    #
    ...
    "qualifier-ceiling": (
        ...
        (
            "chwalinska", "今年六月", "第一场就赢了郑钦文",
            "第二亮的那一格是今年六月。"
            "赫瓦林斯卡赛前世界第一百一十四位，法网正赛还是第一次打。"
            "三场资格赛打上来，正赛第一场就六比四、六比零赢了五号种子——"
            "那是郑钦文。"
            "赫瓦林斯卡一直赢到决赛，三比六、二比六负于安德列耶娃。"
            "三个星期，她的排名从第一百一十四涨到第二十一。",
            "assets/explainer/qualifier-ceiling/chwalinska_rg_final.jpg",
            "WTA 官方图库 · 2026 年 6 月 6 日法网决赛日，赫瓦林斯卡捧着亚军盘",
            ("赛前世界第 114，正赛首秀", "第一场赢的是 5 号种子郑钦文",
             "三个星期，排名从 114 涨到 21"),
        ),
        (
            "yastremska", "两年前", "她比郑钦文多打了四个小时",
            "再往前两年。二零二四年澳网，亚斯特雷姆斯卡也是从资格赛打上来的，"
            "赛前世界第九十三。她一路赢到半决赛，对面还是郑钦文。"
            "四比六、四比六，一小时四十二分钟。"
            "澳网官网当时算过一笔账：那半个月，"
            "她待在场上的时间比郑钦文多了大约四个小时——"
            "因为她比对手多打了三场球。",
            "assets/explainer/qualifier-ceiling/yastremska_uso_qualies_2023.jpg",
            "Hameltion／Wikimedia Commons · CC BY-SA 4.0 · "
            "2023 年美网资格赛首轮，亚斯特雷姆斯卡（不是文中那一场，年份见此）",
            ("赛前世界第 93，资格赛打上来", "半决赛 4-6 4-6 负于郑钦文",
             "那半个月，她多在场上待了 4 小时"),
        ),
        (
            "podoroska", "更早一次", "正赛一场都没赢过，先进了半决赛",
            "更早的一次在二零二零年法网。"
            "波多罗斯卡赛前世界第一百三十一，"
            "而在那之前，她一场大满贯正赛都没赢过。"
            "四分之一决赛，她六比二、六比四赢了三号种子斯维托丽娜。"
            "从资格赛打进大满贯半决赛，女子那边二十一年没有人做到过。",
            "assets/explainer/qualifier-ceiling/podoroska_uso_2023.jpg",
            "Hameltion／Wikimedia Commons · CC BY-SA 4.0 · "
            "2023 年美网，波多罗斯卡（不是文中那一场，年份见此）",
            ("赛前世界第 131", "此前一场大满贯正赛都没赢过",
             "1/4 决赛 6-2 6-4 赢了世界第 3"),
        ),
        (
            "karatsev", "男子这边", "第一次打正赛，就进了半决赛",
            "男子这边最近的一次是二零二一年澳网。"
            "卡拉采夫赛前世界第一百一十四，资格赛打上来，一路赢到半决赛——"
            "那是他第一次打大满贯正赛，公开赛年代没有第二个人做到过。"
            "半决赛他三比六、四比六、二比六输给德约科维奇。"
            "再往前六年，他还在美网的外场打资格赛。"
            "而到这儿为止，男子五十八年只有五个人进过半决赛，"
            "一个决赛都没有。",
            "assets/explainer/qualifier-ceiling/karatsev_uso_qualies_2015.jpg",
            "Steven Pisano／Wikimedia Commons · CC BY 2.0 · "
            "2015 年 8 月 25 日美网资格赛，纽约法拉盛 12 号球场，卡拉采夫",
            ("赛前世界第 114", "大满贯正赛首秀就进半决赛",
             "男子 58 年只有 5 个人到过这一轮"),
        ),
        (
            "mcenroe", "一切的起点", "十八岁，还是业余身份",
            "而这条线的起点在一九七七年温网。"
            "那年麦肯罗十八岁，还是业余身份，从资格赛打起。"
            "三场资格赛加五场正赛，八场球打进半决赛，四盘输给康纳斯。"
            "四十九年过去，男子那条线还停在他到过的地方。"
            "最后说一条规则。翻开大满贯规则书，赛制那一节只有一句话："
            "只有男子正赛是五盘，其余全部是三盘。"
            "也就是说资格赛男女一样；进了正赛，男子要多赢一盘。"
            "这两件事有没有关系，规则书没有说。",
            "assets/explainer/qualifier-ceiling/mcenroe_1978.jpg",
            "Bert Verhoeff／Anefo 荷兰国家档案馆 · CC0 · "
            "1978 年 10 月 21 日荷兰哈勒姆，麦肯罗在比赛中（不是 1977 温网那一场，年份见此）",
            ("1977 温网，18 岁，业余身份", "八场球打进半决赛，四盘负康纳斯",
             "规则书：只有男子正赛是 5 盘"),
            "",
...
_CAPTIONS: dict[str, dict] = {
    "qualifier-ceiling": {
        "hook": (
            ...
            "和 1 个亚军（赫瓦林斯卡今年法网，正赛第一场赢的就是郑钦文）；\n"
            "亚斯特雷姆斯卡 2024 澳网打进半决赛，那半个月她比郑钦文多在场上待了 4 小时；"
            "波多罗斯卡 2020 法网进四强之前，一场大满贯正赛都没赢过。\n"
            "男子只有 5 个人进过半决赛，一个决赛都没有——"
            "卡拉采夫 2021 澳网是正赛首秀就进四强的唯一一人，"
            "而这条线的起点是 1977 年 18 岁的麦肯罗。美网那一格到今天还是空的。"
        ),
