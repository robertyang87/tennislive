...
<svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="450" y="82" text-anchor="middle" fill="#cfe6d8"
        font-size="22" font-weight="700">2026 年 8 月 18 日公布七张，8 月 22 日补最后一张</text>

  <rect x="60" y="112" width="780" height="118" rx="12" fill="rgba(143,214,168,.16)"/>
  <text x="80" y="152" fill="#cfe6d8" font-size="22" font-weight="700">两位老将</text>
  <text x="80" y="192" fill="#f4fbf7" font-size="30" font-weight="800">孟菲尔斯（法国，今年同样退役）</text>
  <text x="80" y="222" fill="#f4fbf7" font-size="26" font-weight="700">波皮林（澳大利亚）</text>

  <rect x="60" y="248" width="780" height="118" rx="12" fill="rgba(143,214,168,.16)"/>
  <text x="80" y="288" fill="#cfe6d8" font-size="22" font-weight="700">五位美国新星</text>
  <text x="80" y="326" fill="#f4fbf7" font-size="27" font-weight="700">迈克尔·郑　马丁·达姆　肯尼迪</text>
  <text x="80" y="358" fill="#f4fbf7" font-size="27" font-weight="700">戈尔兹尼　沃尔夫</text>

  <rect x="60" y="384" width="780" height="80" rx="12" fill="rgba(143,214,168,.16)"/>
  <text x="80" y="420" fill="#cfe6d8" font-size="22" font-weight="700">8 月 22 日，第八张</text>
  <text x="80" y="452" fill="#f4fbf7" font-size="28" font-weight="700">基普森（美国，世界第 116）</text>

  <rect x="60" y="482" width="780" height="76" rx="12" fill="rgba(198,246,90,.12)"
        stroke="#c6f65a" stroke-width="3" stroke-dasharray="10 8"/>
  <text x="450" y="530" text-anchor="middle" fill="#c6f65a"
        font-size="32" font-weight="800">2016 年在这块场地夺冠的那个人：没有</text>
</svg>
"""

# 「这三天发生了什么」——同样是照片拍不下来的东西：一次退赛、一次名单变更。
# ⚠️ 只有第三格给品牌绿：前两天他都在名单外面。
_WAWRINKA_THREE_DAYS_DIAGRAM = """
<svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg">
  <text x="450" y="44" text-anchor="middle" fill="#f4fbf7"
        font-size="36" font-weight="800">三天，名单上换了一个名字</text>
  <text x="450" y="82" text-anchor="middle" fill="#cfe6d8"
        font-size="22" font-weight="700">他没有报名资格赛，外卡是唯一一条路</text>
  ...
  <text x="164" y="338" fill="#cfe6d8" font-size="26" font-weight="700">瓦林卡发出告别长文</text>
  <text x="164" y="374" fill="#cfe6d8" font-size="26" font-weight="700">「永远感激，永远纽约」</text>
...
# ⚠️ 这一屏顺带钉死一件常被记混的事：**2014 那座是澳网，不是美网**。
...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "wawrinka-wildcard": (
        (
            ...
            "八张外卡",
            "名单发完了，冠军还在名单外",
            "先看这份名单。八月十八号，美网公布男单正赛外卡，一口气七张："
            "孟菲尔斯、波皮林，加上五个美国年轻人——迈克尔·郑、马丁·达姆、"
            "肯尼迪、戈尔兹尼、沃尔夫。"
            "孟菲尔斯今年同样是告别赛季，五月的法网，他和瓦林卡是一起拿的外卡。"
            "八月二十二号，第八张也发了，给了美国人基普森，世界第一百一十六位。"
            "八张全部发完，二〇一六年在这块场地上夺冠的那个人，一张都没有。"
            "而瓦林卡没有报名资格赛——外卡本来就是他唯一的一条路。",
            "",
            "示意图 · 网球时差绘制",
            (
                "8 月 18 日七张，8 月 22 日第八张",
                "两位老将 ＋ 五个美国年轻人",
                "2016 年的冠军：一张都没有",
            ),
            _WAWRINKA_EIGHT_WC_DIAGRAM,
        ...
        (
            ...
            "三天",
            "瓦林卡说完再见，位置才空出来",
            "接下来是三天。八月二十五号，瓦林卡在社交媒体上发了一篇长文，"
            "谢纽约，谢美网，谢每一个球迷，最后一句是「永远感激，永远纽约」。"
            "读到这儿，所有人都以为这是道别。"
            "第二天，八月二十六号，美网宣布基普森因伤退赛，把那个位置转给了瓦林卡。"
            "美网官网当天连发两篇稿子，前一篇的标题还是「授予外卡」，"
            "后一篇已经变成了「他将回来打最后一届美网」。"
            "也就是说，这张外卡不是发给他的，是空出来的。",
            "",
            "示意图 · 网球时差绘制",
            (
                "8 月 25 日，他先说完了再见",
                "8 月 26 日，别人退赛，位置才空出来",
                "他是等来的，不是被选中的",
            ),
            _WAWRINKA_THREE_DAYS_DIAGRAM,
        ),
        (
            ...
            "十年前，瓦林卡在这儿赢了冠军",
            "被绕开的这个人，是二〇一六年的美网冠军。"
            "那年的决赛，他六比七、六比四、七比五、六比三击败德约科维奇——"
            "而德约科维奇当时是世界第一。"
            "顺带说一句，很多人把那座奖杯记成二〇一四年的美网；"
            "那一年他拿的是澳网，纽约这一座是二〇一六年。",
        ...
        (
            ...
            "二〇一四年澳网胜纳达尔，二〇一五年法网胜德约科维奇，"
            "二〇一六年美网又一次胜德约科维奇。"
            "四巨头统治的那些年里，能在大满贯决赛上把头号种子拉下来一次已经不容易，"
            "他做了三次，一次都没输过。",
            "",
            "示意图 · 网球时差绘制",
            (
        ...
        (
            ...
            "配图是他自己挑的四张，其中一张是夺冠那天，"
            "他站在曼哈顿的一处楼顶举着奖杯自拍，身后是帝国大厦。",
        ...
        (
            ...
            "前三个",
            "另外三个大满贯，都送过瓦林卡",
            "而今年前三个大满贯，每一个都给了他一个像样的告别。"
            "一月的墨尔本，他四十岁，先赢杰雷，再和赫亚打满五盘，"
            "打进第三轮——一九七八年以来第一个做到这件事的四十岁以上男子球员。"
            "输给弗里茨之后，澳网的赛事总监走上场，和他一起举起了啤酒。"
            "五月的巴黎，他和孟菲尔斯拿着外卡，同一天首轮出局；"
            "二十一年前，两个人也是同一年第一次站上罗兰加洛斯。"
            "六月的伦敦，他首轮碰上贝雷蒂尼，四盘全部打进抢七，"
            "第二盘那个抢七打到十六比十四，他还是输了。"
            "三站都过去了，只剩纽约。",
        ...
        (
            ...
            "二〇〇二年转的职业，打到今天二十四年。"
            "生涯十六个巡回赛单打冠军，最后一个停在二〇一七年；"
            "那之后他做过两次膝盖手术，二〇二一年又做了两次足部手术。"
            "去年十二月他写下一句话：每一本书都需要一个结尾。"
            "现在，这本书只剩纽约这一页了。",
...
_CAPTIONS: dict[str, dict] = {
    "wawrinka-wildcard": {
        "hook": (
            "8 月 18 日七张，8 月 22 日第八张——美网男单正赛的外卡全部发完，"
            "2016 年在这块场地上夺冠的那个人，一张都没有。\n"
            "8 月 25 日他自己发文告别纽约；第二天，拿到第八张的人因伤退赛，"
            "位置才转给了他。"
        ),
