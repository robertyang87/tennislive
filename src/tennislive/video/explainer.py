...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "weeks-at-no1": (
        (
            ...
            "第二天，WTA 官方的排名观察里写了一个数字：这一趟之后，"
            "她和世界第一的差距缩到了五十四分。两个人的总分都在八千以上——"
            "五十四分，是千分之六。",
            "assets/explainer/weeks-at-no1/rybakina.jpg",
            "WTA 官方图库 · 2026 加拿大站多伦多，莱巴金娜",
            ("多伦多决赛 六比二 六比三", "离世界第一 54 分", "两人总分都在八千以上"),
        ),
        (
            "ends", "设榜五十年", "最长三百七十七周 最短两周",
            "世界第一这个位置，从一九七五年设榜到今天，一共只有二十九个女子坐上去过。"
            "坐得最久的是格拉芙，累计三百七十七周，七年多。"
            "而坐得最短的那一个，只有两周。",
            "", "示意图 · 网球时差绘制",
            ("设榜以来共 29 人", "格拉芙累计 377 周", "最短的只坐了两周"),
            weeks_at_no1_chart(),
        ),
        (
            "gap", "最短的那个人", "零点八分把古拉贡送了上去",
...
_CAPTIONS: dict[str, dict] = {
    ...
    "weeks-at-no1": {
        "hook": (
            "世界第一设榜五十年，只有 29 个女子坐上去过——最久的格拉芙累计 377 周。\n"
            "最短的那一个只有两周，而且她是三十一年之后才知道的：当年的成绩单漏录进了电脑。"
        ),
