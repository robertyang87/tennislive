...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    "mandatory-1000": (
        ...
        (
            ...
            "多伦多",
            "这个零，顶掉去年那个零",
            "那这个零有多疼。去年的加拿大站在多伦多，辛纳、德约科维奇、阿尔卡拉斯，"
            "三个人也都没去。那一年他们那一站记的，也是零。"
            "而世界排名是五十二周滚动的：今年这一站的成绩，顶掉去年这一站的成绩。"
            "零顶掉零。也就是说，这次排名处罚落在辛纳身上，是一分不差。"
            "二〇二五年多伦多的大门口一样排着长队，那一年买票进去的人，"
            "也没有看到这三个人。",
        ...
        (
            ...
            "唯一的出口",
            "缺一站罚满，缺两站反而有救",
            "规则书里确实留了一个出口，在第九章第三节的第三条注里："
            "连着缺两个或更多的强制赛——大师赛、大满贯、年终总决赛都算——"
            "可以向医疗委员会提出申请，最多抹掉三个大师赛的零分。"
            "这个条件是反过来的：只缺一站，罚满；连着缺两站以上，反而有救。"
            "因为规则想分的从来不是你缺了几站，是你到底伤了，还是选了。"
            "阿尔卡拉斯今年一月拿了澳网冠军，之后右手腕伤了，法网、温网、"
            "蒙特利尔一路缺到现在——他够得着这个条件。辛纳只缺蒙特利尔这一站，"
            "而下一站辛辛那提他报了名，八月十三号开打，正好是蒙特利尔结束那一天。",
            "assets/explainer/mandatory-1000/alcaraz_wimbledon_2025.jpg",
            "12121343A · Wikimedia Commons · CC BY-SA 4.0 · 2025 年 7 月 4 日，温网，阿尔卡拉斯发球",
            (
                "连缺 2 站以上 可申请抹零",
                "阿尔卡拉斯 够得着",
                "辛纳 只缺 1 站 罚满",
        ...
        (
            ...
            "球迷理应看到世界上最好的球员在场上。"
            "话说到底：规则写着强制，代价却是一个顶掉去年同一个零的零。"
            "当不遵守比遵守还便宜，「强制」这两个字就只剩一个名字。"
            "这不是球员的错。",
            "assets/explainer/masters-format/crowd.jpg",
            "Sorin Nechita · Wikimedia Commons · 蒙特利尔中心球场满场（2009 年罗杰斯杯四强日）",
            (
                "去年 温网后 2 周开打",
                "今年推到 3 周 还是没来",
                "赛事总监 球迷理应看到最好的",
