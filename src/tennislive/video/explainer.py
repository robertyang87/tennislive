...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "wawrinka-wildcard": (
        (
            ...
            "八月二十二号补上第八张，给了美国人基普森，世界第一百一十六位。"
            "八张里有两张，其实不是美网自己挑的。"
            "孟菲尔斯和波皮林走的是交换名额——美网和法网、澳网各有一份互换协议，"
            "美网让出这两张，换回美国球员打法网和澳网的名额。"
            "也就是说，美网真正能自己决定的只有六张，而这六张全给了美国人。"
            "瑞士没有这样的协议，瓦林卡也没有报名资格赛。"
            "八张外卡摆在那儿，二〇一六年在这块场地上夺冠的那个人，"
            "一条通道都不在里面。",
            "",
            "示意图 · 网球时差绘制",
            (
        ...
        (
            ...
            "输给弗里茨那一场之后，他没有直接走。"
            "澳网的赛事总监走上场来，两个人在场地中央举起啤酒碰了一下，"
            "满场的人站着看他喝完。那不是一个失败者的退场。",
        ...
        (
            ...
            "中间他手里握过六个盘点，一个都没保住。"
            "最后三盘全部输在抢七里。"
            "走下球场的时候，一号球场整场站了起来，他红着眼睛回鼓掌。"
            "法网给过他外卡，温网也给过他外卡。三站都过去了，只剩纽约。",
...
_OPENINGS: dict[str, dict] = {
    "wawrinka-wildcard": {
        ...
        # 账号所有者 2026-08-26：「封面标题看不出最后又获得」——原来那版
        # 「八张外卡，为何没有瓦林卡？」只有前半段，读者点不进来就不知道有反转。
        # 现在一句话装下两拍：先没有，四天后有了。
        # 用「没有」不用「绕开」：后者暗示故意，而没有任何证据说美网是故意的
        # ——调侃的是这个流程有多荒诞，不是指控谁（CLAUDE.md 那条封面语义）。
        "question": "八张外卡，瓦林卡怎么进的？",
