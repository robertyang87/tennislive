...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "zheng-eala": (
        (
            ...
            "这是菲律宾球员在 WTA 历史上的最高排名。三年，她从那个输球的人，走到了本国的历史最高处。",
        ...
        (
            ...
            "两周前的雅典，她连赢两场打进八强，那是她十三个月来的第一个巡回赛八强。",
            "",
            "网球时差绘制",
            (
        ...
        (
            ...
            "一个人二十一岁，正在往上爬；另一个人在二十一岁那年，就已经站到过最高的地方。"
...
_CAPTIONS: dict[str, dict] = {
    ...
    "zheng-eala": {
        "hook": (
            "三年前的亚运会半决赛，郑钦文赢了对面这个人，然后拿走金牌。那一年她 21 岁。\n"
            "三年后再见，对面也 21 岁，是生涯新高世界第 28；她自己要靠一张外卡才能进正赛。\n"
            "排名会掉，人还在场上。"
        ),
...
_OPENINGS: dict[str, dict] = {
    ...
    "zheng-eala": {
        ...
        "question": "从金牌到外卡，三年发生了什么？",
        "narration": "三年前的亚运会半决赛，郑钦文赢了对面这个人，然后一路拿走金牌。"
        "三年后再见，对面升到了生涯新高，她自己要靠一张外卡才能进正赛。"
        "从金牌到外卡，中间这三年发生了什么？",
