...
from .williams_cards import doubles_record as williams_doubles_record
...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "williams-sisters": (
        (
            ...
            "上一次",
            "四年前那一场，她们输了",
            "先说上一次。二〇二二年九月一日，美网女双首轮，姐妹俩一起上场，"
            "输给赫拉德茨卡和诺斯科娃，一轮出局。那不只是一场首轮失利——那是小威廉姆斯"
            "职业生涯的最后一场双打。她在那届美网之后离开了球场。所以过去四年里，"
            "这一对组合停在了一场输球上。",
            "assets/explainer/williams-sisters/uso2022.jpg",
            "All-Pro Reels · CC BY-SA 2.0 · Wikimedia Commons · 2022 年 9 月 1 日美网女双首轮",
            (
                "2022 年 9 月 1 日，美网女双首轮出局",
                "那是小威职业生涯最后一场双打",
                "这一对组合停在了一场输球上",
            ),
        ),
        (
            ...
            "这四年",
            "小威回来了，搭档却不是姐姐",
            "然后是一千三百七十五天。二〇二六年六月九日，小威廉姆斯在女王杯复出，"
            "距离她上一场职业比赛整整一千三百七十五天。那一场她赢了，七比六、六比二，"
            "赢的是三号种子。但搭档不是姐姐——是十九岁的姆博科。",
            "assets/explainer/williams-sisters/serena_2026.jpg",
            "Amy Martin Photography · CC BY-SA 4.0 · Wikimedia Commons · 2026 年 6 月 SXSW London（非比赛画面）",
            (
                "1375 天没有打过职业比赛",
                "6 月 9 日女王杯复出，7-6 6-2 赢下首轮",
                "搭档是 19 岁的姆博科，不是姐姐",
            ),
        ),
        (
            ...
            "底子",
            "十七年里，她们一起拿了十四个",
            "值得说清楚她们一起是什么水平。作为一对组合，两人拿过十四个大满贯女双冠军："
            "澳网四个、法网两个、温网六个、美网两个；外加三届奥运女双金牌，"
            "悉尼、北京、伦敦。最后一个大满贯双打冠军是二〇一六年的温网。",
            "",
            "网球时差绘制 · 年份出处：赛事官网外卡公告与维基百科逐年列表两处对上",
            (
                "大满贯女双 14 冠，横跨 1999 到 2016",
                "奥运女双 3 金：悉尼、北京、伦敦",
                "最后一冠停在 2016 年温网",
            ),
            williams_doubles_record(),
        ),
        (
            "tonight",
            "今晚",
            "两张外卡，撞在第一轮",
            "所以今晚这一场是这样来的：姐妹俩拿的是一张双打外卡，而对面的科斯秋克和"
            "斯特恩斯，拿的也是外卡——官方签表上两队并排，都标着 WC。这也是她们第一次"
            "以一对组合的身份打辛辛那提。四十六岁的姐姐这一年一直在打，四十四岁的妹妹"
            "刚回来两个月。",
            "assets/explainer/williams-sisters/venus_2026.jpg",
            "转载页未标注摄影师 · 2026 年 7 月 28 日华盛顿站首轮，大威廉姆斯",
            (
                "两队都是外卡，签表上并排",
                "她们第一次以组合身份打辛辛那提",
                "北京时间 8 月 18 日，不早于 07:00",
            ),
            "",
            "四年之后再站到一起，你希望她们赢吗？",
        ),
...
_CAPTIONS: dict[str, dict] = {
    ...
    "williams-sisters": {
        "hook": (
            "上一次威廉姆斯姐妹一起上场，是 2022 年美网女双首轮——她们一轮出局。\n"
            "那也是小威职业生涯的最后一场双打，此后她离开球场 1375 天。\n"
            "8 月 18 日，两人拿着一张外卡回到辛辛那提，第一次以一对组合的身份打这一站。\n"
            "对面的科斯秋克和斯特恩斯，拿的也是外卡。"
        ),
        "tags": ("网球", "网球时差", "威廉姆斯姐妹", "辛辛那提", "WTA"),
    },
    "venus-potapova": {
        "hook": (
...
_OPENINGS: dict[str, dict] = {
    ...
    "williams-sisters": {
        "column": "开球之前",
        "topic": "威廉姆斯姐妹辛辛那提女双首轮前瞻",
        "question": "四年了，她们为什么又组队？",
        # ⚠️ 第一句要在 5 秒的决定窗口里说完（≤26 字），所以钩子先落地、
        # 交代挪到第二句去。另：这里**不写「上一次威廉姆斯姐妹」**——那六个字
        # 里嵌着「次威廉姆斯」，会被「和规范名只差一个字」那条判据读成想写
        # 「大威廉姆斯／小威廉姆斯」而误报。改个语序就绕开了，不用动判据。
        "narration": "上一次她们一起上场，是四年前。"
        "二〇二二年美网女双首轮，姐妹俩一轮出局；那也是小威廉姆斯职业生涯的最后一场双打。"
        "四年之后，两人拿着一张外卡回到辛辛那提，第一次以一对组合的身份打这一站。"
        "四年了，她们为什么又组队？",
        # ⚠️ 时刻是 **Not Before**，不是 Starts At——官方 Order of Play 上它排在
        # 同一片场地第 4 场之后。CLAUDE.md「一个时刻有三种口径」：省掉「不早于」
        # 三个字就变成一个看着确切的时刻，而熬夜的人正是照着它定闹钟的。
        "fixture": {
            "date": "8.18",
            "level": "WTA1000",
            "site": "辛辛那提",
            "round": "女双首轮",
            # ⚠️ 这条是这条线上第一条**双打**片子：对阵行的一「边」是一支队，不是
            # 一个人，所以判据按 `/` 拆开逐个查表（见那条测试的改动）。
            # ⚠️ 这一边**故意写成集合名**：写全「大威廉姆斯/小威廉姆斯」渲出来
            # 那一行要折三行、末行只剩一个「斯」字，正是「第二行只剩三个字符，
            # 像个错误」那条要躲的。「威廉姆斯姐妹」是中文媒体对这一对的固定叫法，
            # 不是手打的错译，已按规矩显式登记进测试的 `_ON_PURPOSE`；
            # 两个人各自的译名在正文和 ③ 屏里都写着，信息一点没少。
            "players": ("威廉姆斯姐妹", "科斯秋克/斯特恩斯"),
        },
        "image": "assets/explainer/williams-sisters/reunion_2022.jpg",
        "credit": "All-Pro Reels · CC BY-SA 2.0 · Wikimedia Commons · 2022 年 9 月 1 日美网女双首轮",
    },
    "venus-potapova": {
        "column": "开球之前",
