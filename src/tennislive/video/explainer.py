...
_OPENINGS: dict[str, dict] = {
    ...
    "promotional-fees": {
        "topic": "请得动球星的那条规则",
        # ⚠️ **封面不放他俩的脸**，这一条是硬的：CLAUDE.md「封面标题带着指控时，
        # 放谁的脸就是在指认谁」。「花钱请球星来，犯规吗？」配辛纳或阿卡的近景，
        # 读者读到的合成语义是「他拿了钱」——而**没有任何证据支持那句话**
        # （见 `_SCRIPTS` 那条注释）。所以封面用满场看台：被这条规则影响的是
        # 买票的人，而画面上没有任何一个人被指认。
        # ⚠️ 11 个字排一行 106px，过 `_COVER_MIN_ONE_LINE_PX = 84`。
        "question": "花钱请球星来，犯规吗？",
        "narration": "花钱请球星来打，犯规吗？不犯规。"
                     "但整本规则书里只有两档赛事可以——"
                     "大满贯和大师赛，一分都不许给。",
        "diagram": tier_cover(),
        "credit": "示意图 · 网球时差绘制",
