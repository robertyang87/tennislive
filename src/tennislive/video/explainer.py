...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "bu-lucky-loser": (
        (
            ...
            "他刚练完球，正和教练吃午饭，工作人员过来说：你能打了。原定首轮对阵"
            "十二号种子霍达尔的科基纳基斯，两周前在辛辛那提伤了脚踝，一场没打就退赛；"
        ...
        (
            ...
            "钱和退赛",
            "退赛的人拿一半，顶上的人从正赛算",
            "为什么大满贯的空位常常开赛前几天才出来？这和一条二〇一八年起执行的规矩有关。"
        ...
        (
            ...
            "那个人，第三轮五盘打了四小时十九分钟，赢下十三号种子哈恰诺夫，第四轮输给了"
            "兹维列夫。",
            "",
            "示意图 · 网球时差绘制",
            (
