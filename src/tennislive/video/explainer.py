...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "weeks-at-no1": (
        (
            ...
            "她还是世界第二。八月十号那份官方排名上，她和萨巴伦卡差三百五十四分，"
            "两个人的总分都在八千以上。而世界第一那个位置，她一周都没坐过。",
            "assets/explainer/weeks-at-no1/rybakina.jpg",
            "WTA 官方图库 · 2026 加拿大站多伦多，莱巴金娜",
            ("多伦多决赛 六比二 六比三", "官方排名差 354 分", "她生涯还没当过世界第一"),
        ),
        (
