...
_SCRIPTS: dict[str, tuple[tuple, ...]] = {
    ...
    "wimbledon-whites": (
        ...
        (
            ...
            "连鞋面都要以白色为主。画面里是 2026 年温网的莱巴金娜，正好背对镜头——"
            "那一整片后背，就是细则专门点名的地方。遮阳帽、护腕、球裙、球鞋，全是白的。"
            "整幅画面里唯一不白的，是裙摆下露出的那一截深色打底短裤——"
            "那是 2023 年才松开的口子，最后一屏我们细说。",
        ...
        (
            ...
            "画面里还是那场球：2026 年温网，莱巴金娜对梅尔滕斯，记分牌就在右上角。",
            "assets/explainer/wimbledon-whites/oncourt2026.jpg",
            "danielcooper850 · CC BY-SA 4.0 · Wikimedia Commons · 2026 温网 莱巴金娜 对 梅尔滕斯",
            (
                "规则一度要求内衣也是白色",
                "生理期上场是实打实的负担",
                "图为 2026 温网 莱巴金娜对梅尔滕斯",
            ),
        ),
        (
            "relax",
