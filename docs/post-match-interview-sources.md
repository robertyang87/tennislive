...
而首轮的场上采访是**发生了但不发视频**。这条有硬证据：WTA 自己 2026 华盛顿
首轮的战报写着

> **In her on-court interview**, Samsonova stated: "I didn't expect to be here today…"

而同一天 wtatennis.com（扫了 4547600–4548420 共 820 个 ID）、@wta（近 30 条全是
集锦和日集锦）、Tennis Channel（近 120 条里 4 条华盛顿，全是训练和坐访）、
@mubadaladcopen（发布会 + 集锦）——**一条对应的视频都没有**。

所以 WTA 侧的低覆盖是**出片规律**，不是采集漏了。好在推送要的正是 F/SF/QF，
跟它的出片规律对得上。
