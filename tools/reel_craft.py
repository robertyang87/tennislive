...
| 读者说的 | 装闸那天全库量出来的 |
|---|---|
| 技战术交代不清楚 | 249 条里 **191 条（77%）真正的球路描述不足 2 段**——其中 169 条（68%）连一句都没有 |
...
一个月之后 77% 的片子球路描述不足两段。**一条只写在文档里、没有判据的规矩，
...
#: 「赛场之上」至少要有几段带球路描述。
#: 全库 249 条里 191 条（77%）不足 2 段（其中 169 条一句都没有），最好的一条是 5 段。
...
#: 装闸那天（2026-09-19）已经发出去的、球路描述不足 2 段的片子：**191 条**。
...
SHOT_CRAFT_LEGACY = frozenset({
    ...
    "landaluce-draper",
    "lehecka-fils",
    "lehecka-shelton-davis-cup-2026-qualifiers",
    "maria-yastremska",
    "medvedev-damm",
    "medvedev-zandschulp",
