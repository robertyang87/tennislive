...
- **`tirante-landaluce`**（辛辛那提 ATP1000 第三轮，2026-08-17，蒂兰特 7-6(5) 7-6(4) 兰达卢塞）
  - ⚠️ **2026-08-18 换过源片、全部窗口重排了一遍**（账号所有者直接指了 Tennis TV 那条 YouTube）：
    原来用的是赛事官方频道那一版（129.3 秒），现在是 **Tennis TV 自己站上的免费短集锦（154.9 秒 / 1080p）**，多出 25.6 秒。他指的那条 YouTube（`qy9gV57Zc9I`）**仍然地域封锁**（2026-08-18 又验过，run 32099009014，八种 client 全灭），而 Tennis TV 自家站不过 YouTube，**沙箱本地就下得动**，probe 是在本地跑完的。
  - 所以**之前那一版成片作废了**（`output/2026-08-18/reel/tirante-landaluce/` 里的 mp4 链接指向旧剪辑），接回来时要**重渲**，不是只换封面。
  - 缺的仍然只有封面：`cover.portrait` 还是 `frame_at`（抽帧）
